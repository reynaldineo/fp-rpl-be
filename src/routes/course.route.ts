...
export class CourseRoute implements Routes {
  ...
  private initializeRoutes() {
    ...
    this.router.get(`${this.path}/detail/:id`, AuthMiddleware, this.user.getByID);
    ...
    this.router.post(`${this.path}/detail/:id/tapLike`, AuthMiddleware, this.user.tapLike); // like or unlike
    this.router.post(`${this.path}/detail/:id/addComment`, AuthMiddleware, this.user.addComment);
    this.router.put(`${this.path}/detail/:id/update`, AuthMiddleware, this.user.editCourse);
